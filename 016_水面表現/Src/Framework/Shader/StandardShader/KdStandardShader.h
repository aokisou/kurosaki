...
public:
	...
	struct cbObject
	{
		...
		// 水面シェーダー1
		int				WaterEnable = 0;
		Math::Matrix	mR = Math::Matrix::Identity;
		Math::Vector2	WaterUVOffSet = Math::Vector2::Zero;
