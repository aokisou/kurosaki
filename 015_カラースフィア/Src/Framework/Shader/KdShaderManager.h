...
public:
	...
	{
		int ColorEnable = 0;
		Math::Vector3 ColorPos = { 0.f,0.f,0.f };
		float ColorRadius = 0.f;
		Math::Vector3 Color;
	};
	...
	// 黒崎授業5
	void WriteCBColorEnable(const bool _enable);
	void WriteCBColor(const Math::Vector3& _pos, const float& _radius, const Math::Vector3& _color);
