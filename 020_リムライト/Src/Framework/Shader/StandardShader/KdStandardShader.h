...
public:
	...
	struct cbObject
	{
		...
		Math::Vector3 LimLightColor = { 0.f,0.f,0.f };
		float LimLightPow = 1;
	};
	...
	// リムライト有効化
	void SetLimLightEnable(const bool _enable)
	{
	...
	void SetLimLightParam(const Math::Vector3& _col, const float& _pow)
	{
		m_cb0_Obj.Work().LimLightColor = _col;
