...
void Bullet::Init()
{
	...
	m_spModel = KdAssets::Instance().m_modeldatas.LoadData("Asset/Models/Bullet/Bullet.gltf");
	//m_spModel->Load("Asset/Models/Bullet/Bullet.gltf");
	m_spTPoly = std::make_shared<KdTrailPolygon>();
	m_spTPoly->SetMaterial(KdAssets::Instance().m_textures.GetData("Asset/Textures/jet.png"));
