...
void Application::Update()
{
	...
	Math::Matrix transMat, rotateXMat,rotateYMat;
	transMat = Math::Matrix::CreateTranslation(0, 60, -40);
	rotateXMat = Math::Matrix::CreateRotationX(DirectX::XMConvertToRadians(45));
	rotateYMat = Math::Matrix::CreateRotationY(DirectX::XMConvertToRadians(deg));
	m_camera.SetCameraMatrix(rotateXMat * transMat * rotateYMat);
}
...
bool Application::Init(int w, int h)
{
	...
	m_model.Load("Asset/Models/ship2/ship2.gltf");
