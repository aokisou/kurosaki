...
void KdShaderManager::WrightCBConeLightEnable(const bool _enable)
{
...
void KdShaderManager::WrightCBConeLight(const Math::Vector3& _pos, const Math::Vector3& _dir, const float& _range, const float& _angle, const Math::Vector3& _col)
{
	auto& light = m_cb9_Light.Work().ConeLight;
	light.pos = _pos;
	light.dir = _dir;
	light.range = _range;
	light.angle = _angle;
