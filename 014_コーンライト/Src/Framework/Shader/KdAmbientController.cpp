...
void KdAmbientController::SetConeLightEnable(const bool _enable)
{
	KdShaderManager::Instance().WrightCBConeLightEnable(_enable);
}

void KdAmbientController::SetConeLight(const Math::Vector3& _pos, const Math::Vector3& _dir, const float& _range, const float& _angle, const Math::Vector3& _col)
{
	...
	m_parameter.m_coneLightColor = _col;
...
void KdAmbientController::WriteLightParams()
{
	...
	if (m_dirtyConeLight)
	{
		KdShaderManager::Instance().WrightCBConeLight(
			m_parameter.m_coneLightPos, m_parameter.m_coneLightDir,
			m_parameter.m_coneLightRange, m_parameter.m_coneLightAngle, m_parameter.m_coneLightColor
		);
